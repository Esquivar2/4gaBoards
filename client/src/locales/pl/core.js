...
export default {
  ...
  translation: {
    ...
    activity: {
      ...
      cardCommentUpdate: 'Zaktualizowano komentarz <1>{{prevComment}}</1> na <2>{{comment}}</2> w <0>{{card}}</0>',
      ...
      cardTaskUserAdd: 'Dodano użytkownika <1>{{user}}</1> do zadania <2>{{task}}</2> w <0>{{card}}</0>',
      cardTaskUserAddShort: 'Dodano użytkownika <1>{{user}}</1> do zadania <2>{{task}}</2>',
      cardTaskUserRemove: 'Usunięto użytkownika <1>{{user}}</1> z zadania <2>{{task}}</2> w <0>{{card}}</0>',
      cardTaskUserRemoveShort: 'Usunięto użytkownika <1>{{user}}</1> z zadania <2>{{task}}</2>',
